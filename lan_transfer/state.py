...
from lan_transfer.expiry import AUTO_DELETE_SECONDS
from lan_transfer.paths import default_share_root, safe_resolve_under_root
...
class TransferState:
    ...
    def __init__(self) -> None:
        ...
        self._root_dir: Path = default_share_root()
    ...
    def clear_shared_text(self) -> None:
        with self._lock:
            self.shared_text = ""
